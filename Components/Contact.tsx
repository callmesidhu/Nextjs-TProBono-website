  ...
  return (
    <div className="flex flex-col lg:flex-row text-white min-h-screen">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8">
        <h2 className="text-[80px] font-bold mb-4 transform -rotate-90 origin-left">
          Contact Us
        </h2>
        <p className="text-2xl">Phone: 9876546302</p>
        <p className="text-2xl">Email: sidharth@gmail.co.org</p>
