...
const Services = () => {
  return (
    <section id="services" className="p-8 text-white flex flex-col items-center">
      <h2 className="text-3xl font-bold mb-6 mx-6">Our Key Services:</h2>
      <div className="flex flex-col items-center justify-center gap-6 w-full">
        <div className="vbg w-full max-w-4xl h-36 text-white flex items-center justify-center transform -skew-x-12 border-2 rounded-lg vbg shadow-md hover:shadow-lg transition-shadow">
